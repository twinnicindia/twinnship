...
class ChannelPartnersController extends Controller
{
    ...
    function index(){
        ...
        $data['partner']=Channel_partners::all();
    ...
    function delete($id){
        Channel_partners::where('id',$id)->delete();
        echo json_encode(array('status' => 'true'));
    }
    function modify($id){
        $response=Channel_partners::find($id);
    ...
    function status(Request $request){
        ...
        Channel_partners::where('id',$request->id)->update($data);
        echo json_encode(array('status' => 'true'));
    }
