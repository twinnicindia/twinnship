    ...
    <section class="hero-section page-title-area">
        <div class="container">
            <div class="page-title-content text-left">
                <h2>Daily COD Remittance</h2>
                <p class="text-white">Take control of your cash flow and receive payments with no hold</p>
            </div>
        </div>
        <div class="lines">
            <div class="line"></div>
    ...
    <section class="info-section section-padding">
        <div class="container">
            <div class="section-title p-bold">
                <h2>Introducing <br><span>Twinnship Early COD</span></h2>
                <p>Grow your eCommerce business with faster and best-in-industry remittance process</p>
            </div>
            <div class="pt-4 pb-5 mb-md-5 w-75 mx-auto" data-aos="fade-up" data-aos-duration="450">
                <img src="{{asset('public/assets/seller/images/early_cod.png')}}" class="img-fluid" alt="">
            </div>
            <div class="row">
