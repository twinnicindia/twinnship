...
<head>
    ...
    <title> Integrate OMSGuru | {{$config->title}} </title>
        ...
        <div class="content-inner" id="form_div">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="h4 mb-4">Instruction to integrate OMSGuru to Twinnship</h3>
                                <ol class="pl-lg amazon-ints">
                                    <li>Login to OMSGuru Admin Panel.</li>
                                    <li>Go to Apps.</li>
                                    ...
                                    <li>Here you will find OMSGuru API Key, password, Shared Secret.</li>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('seller.oms_submit_omsguru')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            ...
                                            <label class="custom-control-label" for="customCheckDisabled1">Fulfill orders <small>(Enabling this will auto fulfill order in OMSGuru when an order is shipped with Twinnship)</small></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" name="auto_cancel" value="y" checked="checked" class="custom-control-input" id="customCheckDisabled2" disabled>
                                            <label class="custom-control-label" for="customCheckDisabled2">Cancel orders <small>(Enabling this will auto cancel order in OMSGuru when order is cancelled in Twinnship)</small></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            ...
                                            <label class="custom-control-label" for="customCheckDisabled3">Mark as paid <small>(Mark COD orders as paid in OMSGuru when orders are delivered to customer)</small></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
