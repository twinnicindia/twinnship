...
<head>
    ...
    <title>Merge Orders | {{$config->title}} </title>
        ...
        <div class="content-inner" id="data_div">
            <div class="card">
                <div class="card-body" style="min-height:500px;">
                    <h3 class="h4 mb-4">Merge Orders
                        <div class="float-right">
                            <form action="{{route('seller.merge_order')}}" method="post" id="MergeOrderForm" class="d-inline">
                                @csrf
                                <input type="hidden" name="orderIds" id="orderIds">
                                <button type="button" class="btn btn-primary btn-sm mx-0 merge_order_btn" id="mergeButton" style="display: none;" data-placement="top" data-toggle="tooltip" data-original-title="Merge Order"><i class="fa fa-code-merge"></i></button>
                            </form>
                    ...
                    <div style="display: block;">
                        <div class="w-100 float-left" style="max-width: 60%; display: inline-block;">
                            <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm" method="post" id="AllOrderSearchingForm">
                                @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse ml-5" id="A_DateFilterModal">
                                                        ...
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm" method="post" id="A_DateFilterForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_ChannelFilterModal" style="z-index:1;">
                                                        ...
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm" method="post" id="A_channelForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter justify-content-right" style="display:inline;">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_NumberFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_orderIdForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_StatusFilterModal" style="z-index:1px;">
                                                        ...
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm" method="post" id="A_StatusForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_AmountFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm" method="post" id="A_OrderAmountForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyPaymentModal" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm" method="post" id="A_PaymentTypeForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyProductModal" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_ProductFormFilter">
                                                            @csrf
                                            ...
                                            <div class="d-inline-flex align-items-end justify-content-left w-50 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbySKUModal" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class=filterForm mt-0" method="post" id="A_SKUFormFilter">
                                                        @csrf
                                            ...
                                            <div class="d-inline-flex align-items-end justify-content-left w-50 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyQtyModal" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class=filterForm mt-0" method="post" id="A_QtyFormFilter">
                                                        @csrf
                                                        <input type="hidden" name="filter_status" value="all_order">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyPAddress" style="z-index:1; position: absolute;left: 50%;transform: translateX(-50%);background: #ffffff;padding: 15px;border: 1px solid #dee2e6;font-size: 12px;line-height: 18px;border-radius: 5px;">
                                                        ...
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_PickupAddressForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyDAddress" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_DeliveryAddressForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_WeightFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm" method="post" id="A_OrderWeightForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            <div class="row">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_CourierFilterModal" style="width: 230px !important; z-index:1;">
                                                        ...
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_CourierForm">
                                                            @csrf
                                                            <div class="pt-2 pb-1" style="max-height: 180px; white-space: nowrap; overflow-y: auto;">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_AWBNumberFilterModal" style="width: 230px !important; z-index:1;">
                                                        <form action="{{route('seller.merge_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_AWBNumberForm">
                                                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control numberonly" placeholder="Number of packets" id="number_of_packets" name="number_of_packets" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body all_tabs" id="shipping_tab" style="display:none;">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group ship-form-group">
                                        ...
                                        <input type="number" class="form-control numberonly" maxlength="10" placeholder="Phone Number" id="contact" name="contact" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Pincode</label>
                                    <input type="number" class="form-control numberonly" placeholder="Pincode" id="pincode" name="pincode" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div id="single-packets">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" data-id="1" id="product_qty1" name="product_qty[]" class="form-control product_qty numberonly" value="1" placeholder="Product Quantity" required/></td>
                                        <td>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control input-sm weightfield numberonly" placeholder="Weight" id="weight_single" name="weight" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="length">Length (cm)</label>
                                <input type="number" class="form-control numberonly" placeholder="Length (cm)" id="length_single" name="length" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="breadth">Breadth (cm)</label>
                                <input type="number" class="form-control numberonly" placeholder="Breadth (cm)" id="breadth_single" name="breadth" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="height">Height (cm)</label>
                                <input type="number" class="form-control numberonly" placeholder="Height (cm)" id="height_single" name="height" required>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function get_value_filter(divId) {
        ...
        $.ajax({
            ...
            url: "{{ route('seller.merge_orders.ajax_filter_order')}}",
    ...
    $(document).ready(function () {
        ...
        $('.merge_order_btn').click(function () {
            merge_ids = [];
            $('.selectedCheck:visible').each(function () {
                if ($(this).prop('checked'))
                    merge_ids.push($(this).val());
            });
            $('#orderIds').val(merge_ids);
        ...
        function all_order(){
            $.ajax({
                ...
                url: '{{route('seller.merge_orders.get')}}',
                success: function (response) {
        ...
        $(document).on('click', '.reset_value', function () {
            ...
            $.ajax({
                type : 'get',
                url :  '{{url('/')."/merge-orders/reset_key/"}}' + key,
                success : function(){
                    get_value_filter(that.data('id'));
                    $('#'+modal).collapse('hide');
                    $("#A_searchByProductSku").attr('readonly', false);
        ...
        function add_row(cnt) {
            ...
            html += '<td><input type="number" data-id="' + cnt + '" id="product_qty' + cnt + '" name="product_qty[]" class="form-control product_qty numberonly" required="" value="1" placeholder="Product Quantity"/></td>';
        ...
        function add_mps_row(i, target, tab) {
            var html = `
                <tr>
                    ...
                    <td><input type="number" data-id="${i}" id="product_qty${i}" name="product_qty${tab}[]" class="form-control product_qty numberonly" required="" value="1" placeholder="Product Quantity" /></td>
                    </td>
                    <td>
        ...
        function add_mps_row_update(i, target, tab) {
            var html = `
                <tr>
                    ...
                    <td><input type="number" data-id="${i}" id="product_qty${i}" name="product_qty1[]" class="form-control product_qty numberonly" required="" value="1" placeholder="Product Quantity" /></td>
                    </td>
                    <td>
                        ${(i == 1 ?
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control input-sm weightfield numberonly" placeholder="Weight" name="weight_${i}" id="weight_${i}" value="${order.weight/1000}" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ${i == 0 ? `<label for="length_${i}" class="pb-2"><b>Length (cm)</b></label>` : ''}
                                        <input type="number" class="form-control numberonly" placeholder="Length (cm)" name="length_${i}" id="length_${i}" value="${order.length}" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ${i == 0 ? `<label for="breadth_${i}" class="pb-2"><b>Breadth (cm)</b></label>` : ''}
                                        <input type="number" class="form-control numberonly" placeholder="Breadth (cm)" name="breadth_${i}" id="breadth_${i}" value="${order.breadth}" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ${i == 0 ? `<label for="height_${i}" class="pb-2"><b>Height (cm)</b></label>` : ''}
                                        <input type="number" class="form-control numberonly" placeholder="Height (cm)" name="height_${i}" id="height_${i}" value="${order.height}" required>
                                    </div>
                                </div>
                            </div>
                        `);
