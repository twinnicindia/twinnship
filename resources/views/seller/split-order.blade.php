...
<head>
    ...
    <title>Split Orders | {{$config->title}} </title>
        ...
        <div class="content-inner" id="data_div">
            <div class="card">
                <div class="card-body" style="min-height:500px;">
                    <h3 class="h4 mb-4">Split Orders
                        <div class="float-right">
                        </div>
                    </h3>
                    <div style="display: block;">
                        <div class="w-100 float-left" style="max-width: 60%; display: inline-block;">
                            <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm" method="post" id="AllOrderSearchingForm">
                                @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse ml-5" id="A_DateFilterModal">
                                                        ...
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm" method="post" id="A_DateFilterForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" class="form-control" name="end_date" min="{{date('Y-m-d',strtotime('-90 days'))}}" max="{{date('Y-m-d')}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_ChannelFilterModal" style="z-index:1;">
                                                        ...
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm" method="post" id="A_channelForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter justify-content-right" style="display:inline;">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_NumberFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_orderIdForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_StatusFilterModal" style="z-index:1px;">
                                                        ...
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm" method="post" id="A_StatusForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_AmountFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm" method="post" id="A_OrderAmountForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyPaymentModal" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm" method="post" id="A_PaymentTypeForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyProductModal" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_ProductFormFilter">
                                                            @csrf
                                            ...
                                            <div class="d-inline-flex align-items-end justify-content-left w-50 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbySKUModal" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class=filterForm mt-0" method="post" id="A_SKUFormFilter">
                                                        @csrf
                                            ...
                                            <div class="d-inline-flex align-items-end justify-content-left w-50 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyQtyModal" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class=filterForm mt-0" method="post" id="A_QtyFormFilter">
                                                        @csrf
                                                        <input type="hidden" name="filter_status" value="all_order">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyPAddress" style="z-index:1; position: absolute;left: 50%;transform: translateX(-50%);background: #ffffff;padding: 15px;border: 1px solid #dee2e6;font-size: 12px;line-height: 18px;border-radius: 5px;">
                                                        ...
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_PickupAddressForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyDAddress" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_DeliveryAddressForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_WeightFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm" method="post" id="A_OrderWeightForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            <div class="row">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_CourierFilterModal" style="width: 230px !important; z-index:1;">
                                                        ...
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_CourierForm">
                                                            @csrf
                                                            <div class="pt-2 pb-1" style="max-height: 180px; white-space: nowrap; overflow-y: auto;">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_AWBNumberFilterModal" style="width: 230px !important; z-index:1;">
                                                        <form action="{{route('seller.split_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_AWBNumberForm">
                                                            @csrf
...
<div class="modal fade" id="splitOrderModal" tabindex="-1" role="dialog" aria-labelledby="splitOrderModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title h3" id="exampleModalLabel"><img src="{{asset($config->favicon)}}" style="height:30px;width:30px;"> Split Order</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary btn-sm" id="splitOrderButton">Split Orders</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function get_value_filter(divId) {
        ...
        $.ajax({
            ...
            url: "{{ route('seller.split_orders.ajax_filter_order')}}",
    ...
    $(document).ready(function () {
        ...
        function all_order(){
            $.ajax({
                ...
                url: '{{route('seller.split_orders.get')}}',
                success: function (response) {
        ...
        $(document).on('click', '.reset_value', function () {
            ...
            $.ajax({
                type : 'get',
                url :  '{{url('/')."/split-orders/reset_key/"}}' + key,
                success : function(){
                    get_value_filter(that.data('id'));
                    $('#'+modal).collapse('hide');
                    $("#A_searchByProductSku").attr('readonly', false);
        ...
        $(document).on('click', '.allOrderResetBtn', function () {
            showOverlay();
            all_order();
        });
        ...
        $('#nav-tabContent').on('click', '.split_order', function () {
            showOverlay();
            var that = $(this);
            $.ajax({
                url: '{{url('/get-order-items')}}/' + that.data('id'),
                success: function (response) {
                    var contentDiv = $('#splitOrderFormData'),selectContent = '';
                    contentDiv.html('');
                    $('#splitOrderId').val(response.order.id);
                    for (var i=0;i<response.wareHouses.length;i++){
                        var selected = response.wareHouses[i].id == response.order.warehouse_id ? 'selected' : '';
                        selectContent+='<option value="' + response.wareHouses[i].id + '" ' + selected + '> ' + response.wareHouses[i].warehouse_name + '</option>'
                    }
                    for(var i=0;i<response.items.length;i++){
                        contentDiv.append('<tr><td>'+(i+1)+'</td><td>'+response.items[i].product_name+'</td><td><select data-id="' + response.items[i].id + '" name="wareFor_' + response.items[i].id + '" id="wareFor_'+response.items[i].id+'" class="form-control allWareHouses">'+selectContent+'</select></td></tr>');
                    }
        ...
        $('#splitOrderButton').click(function(){
            var allWarehouses = [];
            $('#splitOrderFormData .allWareHouses').each(function () {
                var that = $(this);
                allWarehouses.push(that.data('id') +"_"+ that.val());
            });
            $.ajax({
                type : 'post',
                data : {
                    '_token': '{{csrf_token()}}',
                    'order_id' : $('#splitOrderId').val(),
                    'warehouses' : allWarehouses
                },
                url : '{{route('seller.performSplitOrders')}}',
                success : function (response) {
                    location.reload();
                }
            });
        });
        // accordian of order detail form
