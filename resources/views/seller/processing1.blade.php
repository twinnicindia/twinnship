...
<tr id="row{{$o->id}}" data-sku="{{$o->product_sku}}">
    ...
    <td><a href='{{url("/view-order/$o->id")}}' target="_blank">{{$o->customer_order_number}}</a>&nbsp;&nbsp;@if($o->is_tagged == 'y' && $o->channel == 'shopify')<a class="shopify_tags" id="shopifyTag{{$o->id}}" data-container="body" data-timeout="1000" data-toggle="popover" data-placement="top" data-content="" data-id="{{$o->id}}"><i class="fa fa-tag"></i></a>@endif<br>
