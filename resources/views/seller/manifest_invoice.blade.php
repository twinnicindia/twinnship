            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:1%;"> <img src="data:image/png;base64,{{base64_encode(@file_get_contents(url('https://twinnship.com/barcode/generate-barcode?code='.$m->awb_number)))}}"><br><br></td>
                    </tr>
                   @endforeach
                </tbody>
            </table>
