    ...
    <div class="main-content d-flex flex-column">
        <div class="nav-scroll scroll-bar active card mb-4 col-12">
            <div class="tablist mt-3" id="pills-tab" role="tablist">
                ...
                <div class="me-2" role="presentation">
                    <a class="active" href="{{route('seller.ndr_action_requested')}}" type="button">Action Requested</a>
                </div>
                <div class="me-2" role="presentation">
                    <a class="" type="button" href="{{route('seller.ndr_delivered')}}">Delivered</a>
                </div>
                <div class="me-2" role="presentation">
                    <a class="" href="{{route('seller.ndr_rto')}}" type="button">RTO</a>
                </div>
            </div>
        </div>
                                ...
                                <table class="table">
                                    ...
                                    @forelse($ndr_data as $n)
                                        <tr id="row{{$n->id}}">
                                            ...
                                            <td>
                                                ...
                                                <span class="text-primary font-weight-bold text-capitalize">NDR Requested</span><br>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <a class="border-1 btn btn-primary  text-decoration-none" data-id="{{$n->id}}" data-bs-toggle="offcanvas" data-bs-target="#Escalate" aria-controls="Escalate">
                                                        <i class="far fa-angle-double-left"></i>
                                                    </a>
                                                    <a class="border-1 btn btn-primary  text-decoration-none"  data-id="{{$n->id}}"data-bs-toggle="offcanvas" data-bs-target="#Escalate" aria-controls="Escalate">
                                                        <i class="far fa-radiation"></i>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr id="row1">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <a class="border-1 btn btn-primary  text-decoration-none" data-bs-toggle="offcanvas" data-bs-target="#Escalate" aria-controls="Escalate">
                                                        <i class="far fa-angle-double-left"></i>
                                                    </a>
                                                    <a class="border-1 btn btn-primary  text-decoration-none" data-bs-toggle="offcanvas" data-bs-target="#Escalate" aria-controls="Escalate">
                                                        <i class="far fa-radiation"></i>
