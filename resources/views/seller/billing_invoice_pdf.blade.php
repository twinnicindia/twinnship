                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                            ...
                            <img style="height:40px; padding-left:10px;" src="data:image/png;base64,{{base64_encode(@file_get_contents(asset($config->logo)))}}">
                        </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: bottom; width:30%">
                        <!-- <img src="data:image/png;base64,{{base64_encode(file_get_contents(asset($config->signature_image)))}}" style="max-width: 165px">
