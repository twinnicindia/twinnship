    ...
    <div class="card-body">
        <h3 class="h4">History
            <div class="float-right">
                <button type="button" class="btn btn-primary AddComment btn-sm mx-0"><i class="fal fa-upload"></i> Add Comment</button>
                ...
                <table class="table table-hover mb-0" id="example1">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <a href="{{asset($attechment->image)}}" target="_blank"><img src="{{asset($attechment->image)}}" style="height:100px;">
                            @empty
                            <p></p>
                            @endforelse
                        </td>
...
<div class="modal fade" id="AddCommentWeight" tabindex="-1" role="dialog" aria-labelledby="AddCommentWeightTitle" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content" id="fulfillment_info">
                <form method="post" action="{{route('seller.addWeightRecComment')}}" enctype="multipart/form-data">
                    @csrf
