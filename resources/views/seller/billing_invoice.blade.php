                ...
                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            font-weight: 600;">
                                                    {{$invoice->status}}</span>
                                                <br>
                                                <a href='{{url("billing/invoice/download/$invoice->id")}}' style="height: 17px;"> Download Invoice</a>
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <tr>
                        <td style="width: 60%;padding-left: 25px;">
                            ...
                            @if(Session()->get('MySeller')->id == 20358)
                                 {{Session()->get('MySeller')->first_name ." ".Session()->get('MySeller')->last_name}}
                            @else
                                {{Session()->get('MySeller')->company_name}}
                            @endif
                            <br>
        ...
        <table style="width: 100%;" rules="none" ellspacing="0" cellpadding="0" class="fluid-table stripe-table" border="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding-left: 50px;">Twinship V2 Freight<sup>*</sup></td>
                    <td style="padding-left: 50px;text-align: right;padding-right: 50px;">Rs. {{round($invoice->invoice_amount)}}</td>
                </tr>
                @if(substr($seller_info->gst_number,0,2) == substr($config->gstin,0,2))
                    <tr>
                        <td></td>
                        <td style="padding-left: 50px;">9.00% CGST</td>
                        <td style="padding-left: 50px;text-align: right;padding-right: 50px;">Rs. {{round($invoice->gst_amount / 2)}}</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td style="padding-left: 50px;">9.00% SGST</td>
                        <td style="padding-left: 50px;text-align: right;padding-right: 50px;">Rs. {{round($invoice->gst_amount / 2)}}</td>
                    </tr>
                @else
                    <tr>
                        <td></td>
                        <td style="padding-left: 50px;">18.00% IGST</td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: bottom; width:30%">
                        <!-- <img src="data:image/png;base64,{{base64_encode(@file_get_contents(asset($config->signature_image)))}}" style="max-width: 195px">
    ...
    <center style="border-radius: 10px;padding: 0mm 0 2mm 0;background: #fff;">
        <table style="width: 100%;" rules="none" ellspacing="0" cellpadding="0" class="fluid-table stripe-table" border="0">
            <tbody>
                ...
                <tr>
                    <td style="padding-left: 50px;">{{date('d/m/Y',strtotime($invoice->invoice_date))}}</td>
...
<br>
    <center style="border-radius: 10px;padding: 1mm;background: #fff;text-align: left;word-break: break-all;">
        <p style="padding-left: 50px;">Download Itemized Shipment Details: <a href='{{url("billing/invoice/csv/$invoice->id")}}' class="link-btn">Download Now</a>
        </p>

    </center>
    <p>* Indicates taxable item</p>
    <p>It's system generated invoice & dont require signature.</p>
