...
<head>
    ...
    <title>Reassign Orders | {{$config->title}} </title>
        ...
        <div class="content-inner" id="data_div">
            <div class="card">
                <div class="card-body" style="min-height:500px;">
                    <h3 class="h4 mb-4">Reassign Orders
                        <div class="float-right">
                            <button type="button" class="btn btn-warning btn-sm mx-0" id="ReassignOrder" style="display: none;" data-placement="top" data-toggle="tooltip" data-original-title="Re-assign Order"><i class="fas fa-shipping-fast"></i></button>
                        </div>
                    </h3>
                    <div style="display: block;">
                        <div class="w-100 float-left" style="max-width: 60%; display: inline-block;">
                            <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm" method="post" id="AllOrderSearchingForm">
                                @csrf
                                <input type="hidden" name="filter_status" value="all_order">
                                <div class="row">
                                    <div class="col-6 mt-2 pr-1">
                                        <div class="form-group mb-2">
                                            <input type="text" class="form-control" style="height:38px;" name="order_awb_search" id="order_awb_search" placeholder="Search Orders (Provide comma separated IDs/AWBs/Contact Numbers)" value="{{session('reassign_order_awb_search') ?? ""}}">
                                        </div>
                                    </div>
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse ml-5" id="A_DateFilterModal">
                                                        ...
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm" method="post" id="A_DateFilterForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" class="form-control" min="{{date('Y-m-d',strtotime('-90 days'))}}" max="{{date('Y-m-d')}}" name="start_date" placeholder="Min Amount" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label>End Date</label>
                                                                        <input type="date" class="form-control" min="{{date('Y-m-d',strtotime('-90 days'))}}" max="{{date('Y-m-d')}}" name="end_date" placeholder="Max Amount" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_ChannelFilterModal" style="z-index:1;">
                                                        ...
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm" method="post" id="A_channelForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter justify-content-right" style="display:inline;">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_NumberFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_orderIdForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_StatusFilterModal" style="z-index:1px;">
                                                        ...
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm" method="post" id="A_StatusForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_AmountFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm" method="post" id="A_OrderAmountForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control numberonly" name="min_value" placeholder="Min Amount">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control numberonly" name="max_value" placeholder="Max Amount">
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyPaymentModal" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm" method="post" id="A_PaymentTypeForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyProductModal" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_ProductFormFilter">
                                                            @csrf
                                            ...
                                            <div class="d-inline-flex align-items-end justify-content-left w-50 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbySKUModal" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class=filterForm mt-0" method="post" id="A_SKUFormFilter">
                                                            @csrf
                                            ...
                                            <div class="d-inline-flex align-items-end justify-content-left w-50 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyQtyModal" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class=filterForm mt-0" method="post" id="A_QtyFormFilter">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                        ...
                                        <th>
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyPAddress" style="z-index:1; position: absolute;left: 50%;transform: translateX(-50%);background: #ffffff;padding: 15px;border: 1px solid #dee2e6;font-size: 12px;line-height: 18px;border-radius: 5px;">
                                                        <label>Filter By Warehouse</label>
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_PickupAddressForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_FilterbyDAddress" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_DeliveryAddressForm">
                                                            @csrf
                                            ...
                                            <div class="d-flex align-items-end justify-content-center w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_WeightFilterModal" style="z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm" method="post" id="A_OrderWeightForm">
                                                            @csrf
                                                            <input type="hidden" name="filter_status" value="all_order">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control numberonly" name="min_weight" placeholder="Min Weight">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control numberonly" name="max_weight" placeholder="Max Weight">
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_CourierFilterModal" style="width: 230px !important; z-index:1;">
                                                        ...
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_CourierForm">
                                                            @csrf
                                                            <div class="pt-2 pb-1" style="max-height: 180px; white-space: nowrap; overflow-y: auto;">
                                            ...
                                            <div class="d-flex align-items-end justify-content-left w-100 mb-1">
                                                ...
                                                <div class="filter">
                                                    ...
                                                    <div class="collapse filter-collapse" id="A_AWBNumberFilterModal" style="width: 230px !important; z-index:1;">
                                                        <form action="{{route('seller.reassign_orders.set_filter')}}" class="filterForm mt-0" method="post" id="A_AWBNumberForm">
                                                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Number of packets" id="number_of_packets" name="number_of_packets" min="1" max="10" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="single-packets">
                                <table class="table table-borderless">
                                    ...
                                    <tbody id="single_shipment_product_details">
                                        <tr>
                                            <td><input type="text" data-id="1" id="product_sku1" name="product_sku[]" class="form-control product_sku" placeholder="Product SKU" maxlength="30" required/></td>
                                            <td><input type="text" data-id="1" id="product_name1" name="product_name[]" class="form-control product_name" placeholder="Product Name" maxlength="50" required/></td>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Invoice Amount" id="invoice_amount" maxlength="7" name="invoice_amount">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Shipping Charges</label>
                                    <input type="text" class="form-control" placeholder="Shiping Charges" id="shipping_charges" maxlength="7" name="shipping_charges">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>COD charges</label>
                                    <input type="text" class="form-control" placeholder="Cod Charges" id="cod_charges" maxlength="7" name="cod_charges">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Discount</label>
                                    <input type="text" class="form-control" placeholder="Discount" id="discount" maxlength="7" name="discount">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<!--Ware house Modal -->
<div class="modal fade" id="courier_partner_select" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    function get_value_filter(divId) {
        ...
        $.ajax({
            ...
            url: "{{ route('seller.reassign_orders.ajax_filter_order')}}",
    ...
    $(document).ready(function () {
        ...
        $('#courier_partner_select').on('click', '.BulkReassignOrderBtn', function () {
            showOverlay();
            console.log($(`#partner_keyword_${$(".partner_select:checked").data("id")}`).val());
            document.singleForm.action = $("#courier_partner_select").data("action");
            document.singleForm.submit();
        });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response == 1) {
                            ...
                            if(!$('#courier_partner_select').children(".modal-dialog").hasClass("modal-xl")) {
                                $('#courier_partner_select').children(".modal-dialog").addClass("modal-xl");
                            }
            ...
            if (sel_ids.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        hideOverlay();
                        // if($('#courier_partner_select').children(".modal-dialog").hasClass("modal-xl")) {
                        //     $('#courier_partner_select').children(".modal-dialog").removeClass("modal-xl");
                        // }
                        $('#courier_partner_select').modal('show');
                        $('#partner_details_ship').html(response);
        ...
        //Reset Key Filtering
        $(document).on('click', '.reset_value', function () {
            var that=$(this);
            ...
            $.ajax({
                type : 'get',
                url :  '{{url('/')."/re-assign/reset_key/"}}' + key,
                success : function(){
                    get_value_filter(that.data('id'));
                    $('#'+modal).collapse('hide');
                    $("#A_searchByProductSku").attr('readonly', false);
        ...
        function add_row(cnt) {
            var html = '';
            html += '<tr>';
            html += '<td><input type="text" data-id="' + cnt + '" id="product_sku' + cnt + '" name="product_sku[]" class="form-control product_sku" required="" placeholder="Product SKU" maxlength="30"/></td>';
            html += '<td><input type="text" data-id="' + cnt + '" id="product_name' + cnt + '" name="product_name[]" class="form-control product_name" required="" placeholder="Product Name" maxlength="50"/></td>';
        ...
        function add_mps_row(i, target, tab) {
            var html = `
                <tr>
                    <td><input type="text" data-id="${i}" id="product_sku${i}" name="product_sku${tab}[]" class="form-control product_sku" placeholder="Product SKU" maxlength="30"/></td>
                    <td><input type="text" data-id="${i}" id="product_name${i}" name="product_name${tab}[]" class="form-control product_name" required="" placeholder="Product Name" maxlength="50"/></td>
                    <td><input type="number" data-id="${i}" id="product_qty${i}" name="product_qty${tab}[]" class="form-control product_qty" required="" value="1" placeholder="Product Quantity" maxlength="4"/></td>
                    </td>
                    <td>
        ...
        function add_mps_row_update(i, target, tab) {
            var html = `
                <tr>
                    <td><input type="text" data-id="${i}" id="product_sku${i}" name="product_sku1[]" class="form-control product_sku" placeholder="Product SKU" maxlength="30"/></td>
                    <td><input type="text" data-id="${i}" id="product_name${i}" name="product_name1[]" class="form-control product_name" required="" placeholder="Product Name" maxlength="50"/></td>
                    <td><input type="number" data-id="${i}" id="product_qty${i}" name="product_qty1[]" class="form-control product_qty" required="" value="1" placeholder="Product Quantity" maxlength="4"/></td>
                    </td>
                    <td>
                        ${(i == 1 ?
