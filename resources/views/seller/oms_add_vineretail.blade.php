...
<head>
    ...
    <title> Integrate VineRetail | {{$config->title}} </title>
        ...
        <div class="content-inner" id="form_div">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="h4 mb-4">Instruction to integrate VineRetail to Twinnship</h3>
                                <ol class="pl-lg amazon-ints">
                                    <li>Login to VineRetail Admin Panel.</li>
                                    <li>Go to Apps.</li>
                                    ...
                                    <li>Here you will find VineRetail API Key, password, Shared Secret.</li>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="h4 mb-4">Instruction to integrate VineRetail to Twinnship</h3>
                                <form action="{{route('seller.oms_submit_vineretail')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="vineretail_api_owner">Vineretail Api Owner</label>
                                        <input type="text" class="form-control" id="vineretail_api_owner" name="vineretail_api_owner" value="" placeholder="Enter Vineretail Api Owner" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="vineretail_api_key">Vineretail Api Key</label>
                                        <input type="text" class="form-control" id="vineretail_api_key" name="vineretail_api_key" value="" placeholder="Enter Vineretail Api Key" required>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            ...
                                            <label class="custom-control-label" for="customCheckDisabled1">Fulfill orders <small>(Enabling this will auto fulfill order in VineRetail when an order is shipped with Twinnship)</small></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" name="auto_cancel" value="y" checked="checked" class="custom-control-input" id="customCheckDisabled2">
                                            <label class="custom-control-label" for="customCheckDisabled2">Cancel orders <small>(Enabling this will auto cancel order in VineRetail when order is cancelled in Twinnship)</small></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" name="auto_cod_paid" value="y" checked="checked" class="custom-control-input" id="customCheckDisabled3">
                                            <label class="custom-control-label" for="customCheckDisabled3">Mark as paid <small>(Mark COD orders as paid in VineRetail when orders are delivered to customer)</small></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
