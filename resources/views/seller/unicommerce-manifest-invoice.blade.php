            ...
            <table style="border: none !important;">
                <tr>
                    <td style="width:50%;border: none !important;">
                        Seller : <strong>{{$seller->company_name}}</strong><br>
                        Courier : <strong>{{$PartnerName[$manifest->courier] ?? ''}}</strong>
                    </td>

                    <td style="text-align:right;width:50%;border: none !important;">
                        Manifest Id : {{$manifest_id}}<br>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:1%;"> <img src="data:image/png;base64,{{base64_encode(@file_get_contents(url('/barcode/test.php?code='.$m->awb_number)))}}"><br><br></td>
                    </tr>
                   @endforeach
                </tbody>
            </table>
        </div><br>
        <h4 style="text-align:center;border-bottom: 1px dashed #a3a8ad; border-top: 1px dashed #a3a8ad; padding:7px;">To Be Filled By {{$PartnerName[$manifest->courier] ?? ''}} Executives</h4>
        <br>
        <div class="row" style="display: flex;  justify-content: space-between; margin:2% 4% 5% 4%;">
            <table style="border: none !important;">
                <tr>
                    <td style="width:50%;border: none !important;">
                        Pickup Time : <strong>_________________</strong><br>
                        FE Name : <strong>_____________________</strong><br>
                        FE Signature : <strong>_____________________</strong><br>
                        FE Phone : <strong>_____________________</strong>
                    </td>

                    <td style="text-align:right;width:50%;border: none !important;">
                        Total Item Picked : ______________<br>
