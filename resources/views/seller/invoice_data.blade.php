    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- <img src="{{Session('MySeller')->logo_image==""?asset('public/assets/seller/images/logo.png'):asset(Session('MySeller')->profile_image)}}" alt="" style="height:30px; text-align:center;"> -->
                ...
                @endif
            <h3 style="text-align: center;">{{Session()->get('MySeller')->company_name}}</h3>
            ...
            <table>
                ...
                <tbody>
                    ...
                    @else
                        ...
                        @endforeach
                    @endif
                    @if($order->seller_id == 32155)
                        <tr>
                            <td colspan="3" style="text-align: right;"><h5>Price</h5></td>
                            <td><h5><span style="font-family: DejaVu Sans, sans-serif;">&#8377;</span> {{$order->invoice_amount}}</h5></td>
                        </tr>
                    @else
                        @if(empty($order->igst))
                            <tr>
        ...
        <div class="row">
            ...
            <p style="font-weight: bold;">Authorized Signature for {{Session()->get('MySeller')->company_name}}</p>
        </div>
        @if(!$loop->last)
