                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Weight Reconciliation</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Weight Reconciliation</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <form action="{{route('weight_reconciliation')}}" method="get">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <a class="btn btn-primary" href="{{route('weight_reconciliation')}}">Reset</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{ route('export_weight_reconciliation', request()->query()) }}" type="button" class="btn btn-primary btn-sm float-right mr-2"><i class="fa fa-download"></i> Export CSV</a><br><br>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                @php($cnt=$weight_reconciliation->firstItem())
            ...
            <div class="modal fade" id="bulkupload" tabindex="-1" role="dialog" aria-labelledby="bulkuploadTitle" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content" id="fulfillment_info">
                        <form method="post" action="{{route('import_csv_weight_reconciliation')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12 pb-10 mb-2">
                                        Download sample order upload file : <a class="text-info" href="{{url('assets/admin/WeightRecon.csv')}}">Download</a>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="m-b-10">
